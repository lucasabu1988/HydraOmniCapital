"""
OmniCapital v8.3 Step 4 - Sigmoid Regime Filter (exp51)
==================================================================================
...
print("=" * 80)
print("OMNICAPITAL v8.3 Step 4 - Sigmoid Regime Filter")
print("Continuous sigmoid regime score [0,1] + gradual position scaling - exp51")
print("=" * 80)
...
if __name__ == "__main__":
    ...
    # 5. Print results
    print("\n" + "=" * 80)
    print("RESULTS - OMNICAPITAL v8.3 Step 4 (exp51)")
    print("=" * 80)
    ...
    results['portfolio_values'].to_csv('backtests/exp51_daily.csv', index=False)
    if len(results['trades']) > 0:
        results['trades'].to_csv('backtests/exp51_trades.csv', index=False)

    output_file = 'results_exp51.pkl'
    ...
    print(f"Daily CSV: backtests/exp51_daily.csv")
    print(f"Trades CSV: backtests/exp51_trades.csv")
