"""
OmniCapital v8.3 Step 2 - Risk-Adjusted Momentum (exp49)
==================================================================================
...
print("=" * 80)
print("OMNICAPITAL v8.3 Step 2 - Risk-Adjusted Momentum")
print("Momentum/Vol Signal (Barroso-Santa-Clara 2015) - exp49")
print("=" * 80)
...
if __name__ == "__main__":
    ...
    # 5. Print results
    print("\n" + "=" * 80)
    print("RESULTS - OMNICAPITAL v8.3 Step 2 (exp49)")
    print("=" * 80)
    ...
    results['portfolio_values'].to_csv('backtests/exp49_daily.csv', index=False)
    if len(results['trades']) > 0:
        results['trades'].to_csv('backtests/exp49_trades.csv', index=False)

    output_file = 'results_exp49.pkl'
    ...
    print(f"Daily CSV: backtests/exp49_daily.csv")
    print(f"Trades CSV: backtests/exp49_trades.csv")
