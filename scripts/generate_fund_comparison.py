...
FUNDS = [
    ...
    },
    {
        ...
        'expense_ratio': 0.13,
        'aum': '$4.5B',
        'description': 'Invesco S&P 500 Momentum ETF — momentum puro sobre S&P 500',
        'description_en': 'Invesco S&P 500 Momentum ETF — pure momentum on S&P 500',
        'highlight': False,
        'source': 'yfinance',
    },
    {
...
def main():
    ...
    output = {
        ...
        'notes': [
            ...
            'Invesco SPMO: inception Oct 2015 — S&P 500 Momentum ETF (pure momentum on S&P 500)',
