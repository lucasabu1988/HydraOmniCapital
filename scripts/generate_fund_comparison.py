...
FUNDS = [
    {
        ...
        'expense_ratio': None,
        'aum': None,
        'description': 'HYDRA: Momentum + Rattlesnake + EFA + Cash Recycling (survivorship-corrected)',
        'description_en': 'Full HYDRA: Momentum + Rattlesnake + EFA + Cash Recycling (survivorship-corrected)',
        'highlight': True,
        'source': 'csv',  # loaded from local CSV
    },
    {
        'ticker': 'HYDRA_NET',
    ...
    {
        'ticker': 'PDP',
        'name': 'Invesco DWA Momentum (PDP)',
        'type': 'ETF',
        'inception': 2007,
        'expense_ratio': 0.62,
        'aum': '$1.4B',
        'description': 'Invesco Dorsey Wright Momentum ETF — el ETF momentum mas antiguo',
        'description_en': 'Invesco DWA Momentum ETF — oldest pure momentum ETF',
        'highlight': False,
        'source': 'yfinance',
    },
    {
        'ticker': 'SPMO',
        'name': 'Invesco S&P 500 Momentum (SPMO)',
        'type': 'ETF',
        'inception': 2015,
        'expense_ratio': 0.13,
        'aum': '$4.2B',
        'description': 'Invesco S&P 500 Momentum ETF — momentum dentro del S&P 500',
        'description_en': 'Invesco S&P 500 Momentum ETF — S&P 500 momentum factor',
        'highlight': False,
        'source': 'yfinance',
    },
    {
        'ticker': 'QMOM',
        'name': 'Alpha Architect Quant Mom (QMOM)',
        'type': 'ETF',
        'inception': 2015,
        'expense_ratio': 0.39,
        'aum': '$0.2B',
        'description': 'Alpha Architect US Quantitative Momentum — enfoque academico cuantitativo',
        'description_en': 'Alpha Architect US Quantitative Momentum — academic quantitative approach',
        'highlight': False,
        'source': 'yfinance',
    },
    {
        'ticker': 'VFMO',
        'name': 'Vanguard Momentum (VFMO)',
        'type': 'ETF',
        'inception': 2018,
        'expense_ratio': 0.13,
        'aum': '$1.1B',
        'description': 'Vanguard US Momentum Factor ETF — bajo costo, marca Vanguard',
        'description_en': 'Vanguard US Momentum Factor ETF — low-cost Vanguard brand',
        'highlight': False,
        'source': 'yfinance',
    },
    {
...
def main():
    ...
    output = {
        ...
        'notes': [
            ...
            'PDP: inception Mar 2007 — oldest pure US momentum ETF (Dorsey Wright methodology)',
            'SPMO: inception Oct 2015 — S&P 500 top-100 momentum stocks',
            'QMOM: inception Dec 2015 — Alpha Architect academic quantitative momentum',
            'VFMO: inception Feb 2018 — Vanguard low-cost momentum factor',
