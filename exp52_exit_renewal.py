"""
OmniCapital v8.3 Step 5 - Exit Renewal for Winners (exp52)
==================================================================================
...
print("=" * 80)
print("OMNICAPITAL v8.3 Step 5 - Exit Renewal for Winners")
print("Exit renewal for winners with HOLD_DAYS_MAX bug fix - exp52")
print("=" * 80)
...
if __name__ == "__main__":
    ...
    # 5. Print results
    print("\n" + "=" * 80)
    print("RESULTS - OMNICAPITAL v8.3 Step 5 (exp52)")
    print("=" * 80)
    ...
    results['portfolio_values'].to_csv('backtests/exp52_daily.csv', index=False)
    if len(results['trades']) > 0:
        results['trades'].to_csv('backtests/exp52_trades.csv', index=False)

    output_file = 'results_exp52.pkl'
    ...
    print(f"Daily CSV: backtests/exp52_daily.csv")
    print(f"Trades CSV: backtests/exp52_trades.csv")
