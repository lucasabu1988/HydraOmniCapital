...
var TRANSLATIONS = {
  es: {
    ...
    'hero-alphachart-label': 'Alpha Anual vs S&P 500',
    'hero-alphachart-avg':   'Prom +10.6 pp · 18/27 años positivos',
  ...
  en: {
    ...
    'hero-growth-label':     'Growth',
    'hero-growth-context':   '2000–2026 backtest',
    'hero-alphachart-label': 'Annual Alpha vs S&P 500',
    'hero-alphachart-avg':   'Avg +10.6 pp · 18/27 years positive',
    'hero-feat-experiments':   '60 Experiments',
    'hero-feat-noleverage':    'No Leverage',
    'hero-feat-cashrecycling': 'Cash Recycling',
    'hero-feat-noblackbox':    'No Black Box',
