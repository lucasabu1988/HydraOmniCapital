...
var TRANSLATIONS = {
  es: {
    ...
    'strat-desc-catalyst': 'Equal-weight en ETFs macro (TLT, ZROZ, GLD, DBC) que estén sobre su SMA200. Sin oro permanente — GLD participa vía filtro de tendencia. Rebalancea cada 5 días.',
  ...
  en: {
    ...
    'strat-desc-catalyst': 'Equal-weight macro ETFs (TLT, ZROZ, GLD, DBC) above their SMA200. No permanent gold — GLD participates via trend filter. Rebalances every 5 days.',
