...
def test_positions_and_average_cost_rule():
    ...
    lots = lots_from_ledger(_state(), statuses=("filled",))                 # dashboard default ignores "confirmed"
...
def test_dashboard_uses_the_shared_cost_basis_and_exposes_attribution():
    ...
    assert D._lots_from_ledger is lots_from_ledger or D._lots_from_ledger(st) == lots_from_ledger(st, statuses=("filled",))
