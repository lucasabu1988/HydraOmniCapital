...
(TASK-350) the canonical numbers are below - generated from
`evidence_canonical.json` by `render_evidence.py`, never typed (TASK-408):

<!-- EVIDENCE:BEGIN generated by render_evidence.py from evidence_canonical.json -->
Canonical numbers, S&P 500 point-in-time panel with delistings, 2005-02-11 -> 2026-08-24 (TASK-350, `experiments/engine_backtest.py --oos`, measured 2026-09-08):
