...
**Objetivo declarado:** retorno por unidad de riesgo, no retorno absoluto. Evidencia (simulación con contabilidad ejecutable, panel S&P 500 point-in-time, costes incluidos): el **motor de producción** end-to-end (plan/settle/mark, 1084 planes semanales 2005-2026, TASK-350) da **7.10 % neto, ratio retorno/volatilidad 0.75, maxDD −17.8 %**; la mezcla del laboratorio que lo aproxima da 6.91 / 0.74 / −19.5, contra el screener v8.4 solo (5.5 % / 0.42 / −37.8 %) y SPY comprar-y-mantener (11.0 % / 0.68 / −54.7 %). **Esos ratios no son Sharpe:** son media/desviación del retorno neto anualizadas, sin restar el T-bill (`experiments/engine_backtest.py`), y eso los infla precisamente aquí, donde una manga mantiene efectivo remunerado. El 10 % neto **no se demuestra**; el universo Russell de producción **no está medido** (solo S&P 500). No hay track record: el único registro vivo es el ledger de `state/`.
