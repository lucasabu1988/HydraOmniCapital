...
- [x] Created `run_meta_validation.py` — fully wired with data loading + real A/B harness execution. Ready for long windows.
...
- [x] Longer windows (2015-2025, 2010-2025, etc.) are now directly runnable with the provided commands in the validation report.
