"""
OmniCapital v8.3 Step 1 - Validated Parameters (exp48)
==================================================================================
...
print("=" * 80)
print("OMNICAPITAL v8.3 Step 1 - Validated Parameters")
print("Momentum 105d + Wider Trailing (8%/5%) - exp48")
print("=" * 80)
...
if __name__ == "__main__":
    ...
    # 5. Print results
    print("\n" + "=" * 80)
    print("RESULTS - OMNICAPITAL v8.3 Step 1 (exp48)")
    print("=" * 80)
    ...
    results['portfolio_values'].to_csv('backtests/exp48_daily.csv', index=False)
    if len(results['trades']) > 0:
        results['trades'].to_csv('backtests/exp48_trades.csv', index=False)

    output_file = 'results_exp48.pkl'
    ...
    print(f"Daily CSV: backtests/exp48_daily.csv")
    print(f"Trades CSV: backtests/exp48_trades.csv")
