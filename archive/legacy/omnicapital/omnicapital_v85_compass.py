...
if __name__ == "__main__":
    ...
    results['portfolio_values'].to_csv('backtests/v85_compass_daily.csv', index=False)
    if len(results['trades']) > 0:
        results['trades'].to_csv('backtests/v85_compass_trades.csv', index=False)

    output_file = 'results_v85_compass.pkl'
