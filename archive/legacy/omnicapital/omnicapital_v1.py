...
Investment Algorithm - Full Capital Deployment Strategy

Copyright (c) 2026 Investment Capital Firm
All Rights Reserved.

Official Release: OmniCapital v1.0
Strategy: Value-First with 100% Capital Deployment
...
def run_omnicapital_v1(start_date, end_date, initial_capital=1000000):
    """
    Backtest usando 100% del capital
    """
    print("=" * 95)
    print("ALPHAMAX OMNICAPITAL v1.0")
    print("Full Capital Deployment Investment Algorithm")
    print("=" * 95)
    ...
    # === RESULTADOS ===
    print("\n" + "=" * 95)
    print("OMNICAPITAL v1.0 - RESULTADOS OFICIALES")
    print("=" * 95)
...
if __name__ == '__main__':
    ...
    results, trades = run_omnicapital_v1(start_date, end_date)
