"""
OmniCapital v8.3 Step 3 - Smooth Drawdown Scaling (exp50)
==================================================================================
...
print("=" * 80)
print("OMNICAPITAL v8.3 Step 3 - Smooth Drawdown Scaling")
print("Piecewise-linear DD scaling + crash velocity circuit breaker - exp50")
print("=" * 80)
...
if __name__ == "__main__":
    ...
    # 5. Print results
    print("\n" + "=" * 80)
    print("RESULTS - OMNICAPITAL v8.3 Step 3 (exp50)")
    print("=" * 80)
    ...
    results['portfolio_values'].to_csv('backtests/exp50_daily.csv', index=False)
    if len(results['trades']) > 0:
        results['trades'].to_csv('backtests/exp50_trades.csv', index=False)

    output_file = 'results_exp50.pkl'
    ...
    print(f"Daily CSV: backtests/exp50_daily.csv")
    print(f"Trades CSV: backtests/exp50_trades.csv")
