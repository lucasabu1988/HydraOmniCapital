"""
OmniCapital v8.3 COMPASS - Production Candidate
==================================================================================
...
print("=" * 80)
print("OMNICAPITAL v8.3 COMPASS - Production Candidate")
print("COMPASS v8.3 Production Candidate")
print("=" * 80)
...
if __name__ == "__main__":
    ...
    # 5. Print results
    print("\n" + "=" * 80)
    print("RESULTS - OMNICAPITAL v8.3 COMPASS")
    print("=" * 80)
    ...
    results['portfolio_values'].to_csv('backtests/v83_compass_daily.csv', index=False)
    if len(results['trades']) > 0:
        results['trades'].to_csv('backtests/v83_compass_trades.csv', index=False)

    output_file = 'results_v83_compass.pkl'
    ...
    print(f"Daily CSV: backtests/v83_compass_daily.csv")
    print(f"Trades CSV: backtests/v83_compass_trades.csv")
